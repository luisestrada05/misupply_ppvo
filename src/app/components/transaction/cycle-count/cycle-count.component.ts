...
export class CycleCountComponent implements OnInit {
  ...
  // get lotNoValido() {
  //   return this.detalle.get('Lot').invalid && this.detalle.get('Lot').touched;
  // }

  // get lot() {
  //   return this.detalle.get('Lot') as FormControl;
  // }
  ...
  //     this.listShipDestino = response.response.ttdestino.ttdestino;
  //     this.getCatPartes();
  //   }, err => {
  //     this.spinner.hide();
  ...
  //     console.log(this.encabezado.value);
  //   }
  // }
  ...
  //     return b.ttcodigo === parameter;
  //   });
  //   console.log(details[0]);
  //   this.nameShipto = details[0].ttdesc;
  // }
  ...
  //     ShipTo: this.encabezado.value.shipTo,
  //     transferId: this.encabezado.value.reference,
